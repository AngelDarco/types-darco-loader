  ...
  [&>div>.svg]:after:border-orange-500
    ...
    ">
        <div>
          ...
          <div className="svg w-14 h-14 rounded-full bg-orange-500 p-2 after:!left-[50%]
          after:animate-loader1">
            <svg fill='var(--color)' id='ww-search' version='1.1' xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 13 14'><path d='M9 6.5q0-1.445-1.027-2.473t-2.473-1.027-2.473 1.027-1.027 2.473 1.027 2.473 2.473 1.027 2.473-1.027 1.027-2.473zM13 13q0 0.406-0.297 0.703t-0.703 0.297q-0.422 0-0.703-0.297l-2.68-2.672q-1.398 0.969-3.117 0.969-1.117 0-2.137-0.434t-1.758-1.172-1.172-1.758-0.434-2.137 0.434-2.137 1.172-1.758 1.758-1.172 2.137-0.434 2.137 0.434 1.758 1.172 1.172 1.758 0.434 2.137q0 1.719-0.969 3.117l2.68 2.68q0.289 0.289 0.289 0.703z'></path></svg>
          </div>
        ...
        <div>
          <div className="svg w-14 h-14 rounded-full bg-orange-500 p-2 
          after:animate-loader2
          after:!left-[50%]
          ">
            <svg fill='var(--color)' id='ww-child' version='1.1' xmlns='http://www.w3.org/2000/svg' width='100%' height='100%' viewBox='0 0 10 14'><path d='M9.281 4.281l-2.281 2.281v6.437q0 0.359-0.258 0.617t-0.617 0.258-0.617-0.258-0.258-0.617v-3h-0.5v3q0 0.359-0.258 0.617t-0.617 0.258-0.617-0.258-0.258-0.617v-6.437l-2.281-2.281q-0.219-0.219-0.219-0.531t0.219-0.531 0.531-0.219 0.531 0.219l1.781 1.781h2.875l1.781-1.781q0.219-0.219 0.531-0.219t0.531 0.219 0.219 0.531-0.219 0.531zM6.75 3q0 0.727-0.512 1.238t-1.238 0.512-1.238-0.512-0.512-1.238 0.512-1.238 1.238-0.512 1.238 0.512 0.512 1.238z'></path></svg>
          </div>
